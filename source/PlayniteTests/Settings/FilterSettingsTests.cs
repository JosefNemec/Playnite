...
namespace PlayniteTests.Settings
{
    [TestFixture]
    public class FilterSettingsTests
    {
        ...
        public void ShouldSerializeTest()
        {
            ...
            StringAssert.DoesNotContain(nameof(FilterSettings.ReleaseDate), json);
            ...
            StringAssert.Contains(nameof(FilterSettings.ReleaseDate), json);
