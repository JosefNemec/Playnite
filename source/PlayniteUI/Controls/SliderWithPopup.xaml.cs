...
namespace PlayniteUI.Controls
{
    ...
    public partial class SliderWithPopup : UserControl
    {
        ...
        public static readonly DependencyProperty SliderValueProperty = DependencyProperty.Register("SliderValue", typeof(double), typeof(SliderWithPopup));
        ...
        public static readonly DependencyProperty SliderMaximumValueProperty = DependencyProperty.Register("SliderMaximumValue", typeof(double), typeof(SliderWithPopup));
        ...
        public static readonly DependencyProperty SliderMinimumValueProperty = DependencyProperty.Register("SliderMinimumValue", typeof(double), typeof(SliderWithPopup));
        public string PopupLabel
        {
            get => (string)GetValue(PopupLabelProperty);
            set => SetValue(PopupLabelProperty, value);
        }
        public static readonly DependencyProperty PopupLabelProperty = DependencyProperty.Register("PopupLabel", typeof(string), typeof(SliderWithPopup));
