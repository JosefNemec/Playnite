...
public interface IPowerShellRuntime : IDisposable
{
    ...
    CommandInfo? GetModuleFunction(string name);
    void ImportModule(string path);
    object? InvokeModuleFunction(string name, List<object> arguments);
}
...
public class DummyPowerShellRuntime : IPowerShellRuntime
{
    ...
    public CommandInfo? GetModuleFunction(string name)
    {
    ...
    public object? InvokeModuleFunction(string name, List<object> arguments)
    {
        return null;
    }
...
public class PowerShellRuntime : IPowerShellRuntime
{
    ...
    public CommandInfo? GetModuleFunction(string name)
    {
        ...
        if (module.ExportedCommands.TryGetValue(name, out var command))
        {
            return command;
        }
    ...
    public object? InvokeModuleFunction(string name, List<object> arguments)
    {
        try
        {
            var command = GetModuleFunction(name);
